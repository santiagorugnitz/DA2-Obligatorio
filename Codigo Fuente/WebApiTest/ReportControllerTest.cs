...
namespace WebApiTest
{
    ...
    public class ReportControllerTest
    {
        ...
        public void GetReport()
        {
            ...
            mock.Setup(x => x.AccomodationsReport(1, It.IsAny<DateTime>(), It.IsAny<DateTime>())).
                Returns(new List<ReportItem>() { new ReportItem() { Accomodation = new Accomodation(), ReservationsQuantity = 1 } });
