...
export class AccommodationService {
  ...
  getAccommodationByTouristSpot(spotId: Number): Accommodation[] {
    ...
    accommodations.push({ Name: 'Hotel 1', Id: 1, Images: images, Address: 'Calle 1234', Stars: 2, Description: 'xd', Fee: 300, Total: 0 })

    const stars = 2.5;
    accommodations.push({ Name: 'Hotel 2', Id: 2, Images: images, Address: 'Hotel 2', Stars: stars, Description: '', Fee: 100, Total: 0 })

    const stars2 = 3.5;
    accommodations.push({ Name: 'Hotel 3', Id: 3, Images: images, Address: 'Hotel 3', Stars: stars2, Description: '', Fee: 200, Total: 0 })
