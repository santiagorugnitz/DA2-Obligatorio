...
export class AccommodationService {
  ...
  constructor() {
    ...
    this.accommodations.push({SpotId: 1, Name: 'Hotel 1', Id: 1, Images: this.images, Address: 'Hotel 1', Stars: 2, Description: '', Fee: 300, Total: 0, State: true ,selectedImage:0})
    const stars = 2.5;
    this.accommodations.push({SpotId: 1, Name: 'Hotel 2', Id: 2, Images: this.images, Address: 'Hotel 2', Stars: stars, Description: '', Fee: 100, Total: 0 ,State: true,selectedImage:0})
    const stars2 = 3.5;
    this.accommodations.push({SpotId: 1, Name: 'Hotel 3', Id: 3, Images: this.images, Address: 'Hotel 3', Stars: stars2, Description: '', Fee: 200, Total: 0, State: true,selectedImage:0})
